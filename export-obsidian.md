...
`Issues/<issue-slug>.md`
- Metadata: id, volume, publication_date, authors, tags, created_at, updated_at (authors and tags include Obsidian links back to the dashboard headings that group the issue)
